...
**Spawning Mechanism**: Use Kiro's `use_subagent` tool to spawn parallel sub-agents:
...
- content:
  - subagents:
    - query: "Analyze module M-xxx for DFD elements..."
      relevant_context: "Module context and dependencies"
```

**Concurrency Control**:

- Maximum parallel sub-agents: 4 (Kiro limit)
